 ...
 * Class: CalculatorGUI
 *
 * Description: This class provides the graphical front for the calculator.  Takes in the information
 * and uses the method actionPerformed() to call the calculation method in the calculator class.
 *
 * @Author : IC
 * @Version : 1.0
 * @Date : Jan 2016
